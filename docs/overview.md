...
```txt
Theseus.teleopPeriodic()                                        | Just during teleop mode: use the controllers
  Theseus.manuallyDrive()                                       |
...
Theseus.robotPeriodic()                                         | Always: update vision and LEDs
  ...
  Theseus.maybeSetOperatorPerspective()                         | Check if the robot knows where it's facing
  ...
  Theseus.updateLights()                                        |
    ...
    …otherwise…                                                |
      Theseus.currentShift()                                    | What shift is it (for teleop)?
      Theseus.hubIsActive()                                     | Can we score in the hub right now?
